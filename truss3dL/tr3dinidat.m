...
% c0   : initial cosine
  ...
  x10  = crd0(k1,1); y10 = crd0(k1,2); z10 = crd0(k1,3);
  x20  = crd0(k2,1); y20 = crd0(k2,2); z20 = crd0(k2,3);
  l0   = sqrt((x20-x10)*(x20-x10)+(y20-y10)*(y20-y10)+(z20-z10)*(z20-z10));
  Gl0  = 1;
  s0   = (y20-y10)/l0;
  c0   = (x20-x10)/l0;
...
% Data are stored in the data arrays
  ...
  elda0(e,11:20)  = [1  1   0   0  0    Gs0  0   0 0   0   ];       
